...
- **Exciter:** Exciter ini yang bertugas menyuplai arus medan DC ke rotor generator, besar-kecilnya arus yang disuplai itu sebanding sama sinyal kendali yang datang dari Amplifier tadi. Ada dua jenis Exciter yang biasa dipakai: yang pertama rotating/brushless exciter (versi mekanis, biasanya satu poros sama generator utamanya), yang kedua static exciter yang biasanya berbasis thyristor dan ambil sumber dayanya langsung dari terminal generator itu sendiri buat di-rectify jadi DC. Exciter ini sebenarnya yang jadi "penghubung" antara Controller (Amplifier) dengan Plant (Generator) — soalnya sinyal kendali yang tadinya cuma sinyal listrik kecil, di sini baru benar-benar diubah jadi arus medan fisik yang langsung mempengaruhi kekuatan medan magnet di rotor, yang pada akhirnya menentukan besar-kecilnya tegangan output generator.
